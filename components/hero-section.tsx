...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full h-[90vh] md:h-screen bg-white pt-16 overflow-hidden">
      <div className="h-full w-full grid grid-cols-1 md:grid-cols-2">
        
        {/* Left: Content */}
        <div className="relative flex items-center justify-center px-8 sm:px-12 md:px-20 py-20 z-10 bg-white">
          <div className={`max-w-xl transition-all duration-1000 ease-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <h1 className="text-6xl sm:text-7xl lg:text-9xl font-black leading-[0.85] mb-8 tracking-tighter text-gray-900">
              Artisanal <br />
              <span className="text-gray-300">Elegance</span>
            </h1>
            
            <p className="text-base sm:text-lg text-gray-500 mb-12 leading-relaxed font-light max-w-md">
            ...
            <div className="flex flex-wrap gap-6">
              <Link
                href="/shop"
                className="group relative overflow-hidden bg-black text-white px-10 py-4 text-[10px] font-bold tracking-[0.3em] uppercase transition-all hover:bg-gray-900"
              >
              ...
              <Link
                href="/#story"
                className="px-10 py-4 text-[10px] font-bold tracking-[0.3em] uppercase border border-gray-100 hover:border-black transition-colors"
              >
                Our Story
              </Link>
            </div>
        ...
        <div className="relative h-full w-full bg-white overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-white/10 to-transparent pointer-events-none md:hidden" />
        </div>
